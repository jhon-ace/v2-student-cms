    ...
    <div class="overflow-x-auto">
        ...
        @else
            <table class="table-auto border-collapse border border-gray-400 w-full text-center mb-4">
                ...
                <form id="deleteSelectedForm" action="{{ route('program.deleteSelected') }}" method="POST" onsubmit="return confirm('Are you sure you want to delete the selected program?');">
                        @csrf
                        @method('DELETE')
                        ...
                        <tr>
                            ...
                            <td class="text-black border border-gray-400 px-4 py-2">
                                <div class="flex justify-center items-center space-x-2">
                                    <a href="{{ route('program.edit', $program->id) }}" class="bg-blue-500 text-white text-sm px-3 py-2 rounded hover:bg-red-500">
